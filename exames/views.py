...
def cancelar_pedido (request, pedido_id) : 
    ...
    if not pedido.usuario == request.user :
        messages.add_message(request, constants.ERROR, 'Você não pode alterar este pedido') 
        return redirect('/exames/gerenciar_pedidos/')
    pedido.agendado = False
    pedido.save()
    messages.add_message(request, constants.ERROR, 'Pedido cancelado com sucesso')  
    return redirect('/exames/gerenciar_pedidos/')
